...
import numpy as np
import imageio.v2 as imageio   # ✅ Use v2 explicitly to avoid DeprecationWarning
...
for file in os.listdir(sDataBaseDir):
    if file.endswith(".jpg"):
        ...
        # ✅ Use imageio.v2.imread to remove warning
        ...
        if f == 1:
            ...
            ProcessData = pd.concat([ProcessData, ProcessFrameData], ignore_index=True)
