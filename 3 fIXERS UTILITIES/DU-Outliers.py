...
print(AllData)
# =============================================================
# Mean and Standard Deviation for London
# =============================================================
MeanData = AllData.groupby(['Country', 'Place_Name'])['Latitude'].mean()
StdData = AllData.groupby(['Country', 'Place_Name'])['Latitude'].std()
# ✅ Fix: Convert to float properly using .iloc[0]
UpperBound = float((MeanData + StdData).iloc[0])
LowerBound = float((MeanData - StdData).iloc[0])
print('Outliers')
...
print('Not Outliers')
OutliersNot = AllData[
    (AllData.Latitude >= LowerBound) & (AllData.Latitude <= UpperBound)
]
print(OutliersNot)
################################################################
